...
const PUBLIC_FILES = new Set([
  ...
  'number-tools.html', 'number-tools-standalone.html', 'number-models.js', 'number-settlement.js', 'number-app.js',
  'data/numbers/dashboard.js', 'data/numbers/dashboard.json',
